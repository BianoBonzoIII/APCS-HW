...
public class Stats {
    ...
    */
	...
	num1 = a; // Using variables to store the ints
	num2 = b;
	if (num1 % num2 == 0) { 
	...
	while (num1 > 0 && num2 > 0) { // The moment one number reaches zero, the loop is over
	    if (num1 == 0) {
    ...
    */
	...
	// Should produce 2 as the GCD
	System.out.println(Stats.gcd(78, 244));
    }
}
